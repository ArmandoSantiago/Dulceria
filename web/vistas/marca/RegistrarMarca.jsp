<%-- 
    ...
    Created on : 22/10/2018, 09:28:26 AM
    Author     : reynel
--%>
    ...
    <body>
        ...
        <div class="container">            
            <div class="mx-auto col-md-12">
                ...
                <form action="<%=context%>/registrarMarca" method="POST">
                    <div class="form-group">
                        <label for="nombreMarca">Nombre marca:</label>
                        <input type="text" class="form-control" id="nombreMarca" name="bean.nombreMarca" placeholder="" />
                    </div>
                    <div class="form-group">
                        <label for="telefono">Teléfono:</label>
                        <input type="text" class="form-control" id="telefono" name="bean.telefono" placeholder="" />
                    </div>
                    <div class="form-group">
                        <label for="direccion">Dirección:</label>
                        <input type="text" class="form-control" id="direccion" name="bean.direccion" placeholder="" />
                    </div>
                    <div class="form-group">
                        <label for="correo">Correo electrónico:</label>
                        <input type="text" class="form-control" id="correo" name="bean.correo" placeholder="" />
                    </div>
                    <div class="form-group">
